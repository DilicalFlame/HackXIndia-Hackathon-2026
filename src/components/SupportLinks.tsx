...
const SupportLinks = () => {
  ...
  return (
    <div className='my-2 flex flex-col items-center gap-2'>
      <p className='text-neutral-content text-sm'>{_('Get Help from the HackXIndia26 Community')}</p>
      <div className='flex gap-4'>
        <Link
          href='https://github.com/HackXIndia26/HackXIndia26'
        ...
        <Link
          href='https://reddit.com/r/HackXIndia26/'
