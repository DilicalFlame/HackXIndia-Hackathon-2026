...
export const DATA_SUBDIR = 'HackXIndia26';
...
export const DOWNLOAD_HackXIndia26_URL = 'https://HackXIndia26.com?utm_source=HackXIndia26_web';

export const HackXIndia26_WEB_BASE_URL = 'https://web.HackXIndia26.com';
export const HackXIndia26_NODE_BASE_URL = 'https://node.HackXIndia26.com';

const LATEST_DOWNLOAD_BASE_URL = 'https://download.HackXIndia26.com/releases';

export const HackXIndia26_UPDATER_FILE = `${LATEST_DOWNLOAD_BASE_URL}/latest.json`;

export const HackXIndia26_CHANGELOG_FILE = `${LATEST_DOWNLOAD_BASE_URL}/release-notes.json`;

export const HackXIndia26_PUBLIC_STORAGE_BASE_URL = 'https://storage.HackXIndia26.com';

export const HackXIndia26_OPDS_USER_AGENT = 'HackXIndia26/1.0 (OPDS Browser)';
